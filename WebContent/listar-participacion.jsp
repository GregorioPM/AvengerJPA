...
<body>
    ...
    <div class="container pt-3">
    	<div class="row">
        	<h3 class="text-center">Participacion Peliculas</h3>
        	<a href="Heroe?action=new"><i id="plus-icon" class="fas fa-plus-circle"></i></a>
        </div>
        <div class="row">
        <h2>El heroe ${heroe.nombre}</h2>
	        ...
	        <table class="table table-bordered">
	            ...
	            <tbody>
	                <!--   for (Todo todo: todos) {  -->
	         		<c:forEach var="pelicula" items="${participaciones}">
	         		
	             	<tr>
		                 
		                 <td><c:out value="${pelicula.id}" /></td>
		                 <td><c:out value="${pelicula.nombre}" /></td>
		                 <td><c:out value="${pelicula.clasificacionBean.getId()}" /></td>		                 		                 
